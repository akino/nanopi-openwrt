...
wget -NP /tmp https://ghproxy.com/https://raw.githubusercontent.com/biliwala/nanopi-openwrt/zstd-bin/truncate
wget -NP /tmp https://ghproxy.com/https://raw.githubusercontent.com/biliwala/nanopi-openwrt/zstd-bin/ddnz
